...
//       PhotoBoardServiceImpl의 add(), update(), delete() 메서드에 붙인 애노테이션을 제거한다.
// 3) AOP 라이브러리 추가한다.
...
//       스프링 IoC 컨테이너에서 Proxy 생성 기술을 사용하기 때문에 AOP 기능을 사용할 일이 없다.
//    => 그러나 XML에서 트랜잭션 advice를 이용하여 트랜잭션을 다룰 때는
