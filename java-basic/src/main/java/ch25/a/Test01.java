...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    //    4) eclipse project를 refresh 한다.
    //       - 프로젝트에 mariadb jdbc driver 라이브러리가 추가 되었는지 확인한다.
    //
    ...
    // => MariaDB의 JDBC Driver에서 org.mariadb.jdbc.Driver 클래스가 이 구현체이다.
    try {
