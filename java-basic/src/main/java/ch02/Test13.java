...
public class Test13 {
  public static void main(String[] args) {
    ...
    // H : 날짜 및 시각 데이터에서 시각을 추출하여 24시로 표현한다. ex)
    // I : 날짜 및 시각 데이터에서 시각을 추출하여 12시로 표현한다. ex) 
    System.out.printf("%1$tH, %1$tI\n", today);
    
    // M : 날짜 및 시각 데이터에서 시각을 추출하여 분을 표현한다. ex)
    System.out.printf("%1$tM\n", today);
    
    // S : 날짜 및 시각 데이터에서 시각을 추출하여 초를 표현한다. ex)
    // L : 날짜 및 시각 데이터에서 시각을 추출하여 밀리초를 표현한다. ex)
    // N : 날짜 및 시각 데이터에서 시각을 추출하여 나노초를 표현한다. ex)
    System.out.printf("%1$tS, %1$tL, %1$tN\n", today);
    
    // p : 오전 오후 출력하기
    //      소문자 t를 사용하면 am 또는 pm 으로 출력하고,
    //      대문자 T를 사용하면 AM 또는 PM 으로 출력한다.
