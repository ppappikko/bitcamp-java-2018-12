...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    // => 이 해쉬값을 가지고 저장할 위치를 결정한다.
    //
    map.put("aaa", new Student("홍길동", 20));
    // 1) "aaa" String 객체에 대해 hashCode()를 호출하여 해쉬 값을 얻는다.
    // 2) 그 해쉬 값을 사용하여 저장할 위치를 결정한다.
    // 3) 해당 위치에 Student 객체(주소)를 저장한다.
    ...
    System.out.println(key1.hashCode() == key2.hashCode()); // 해쉬 값은 같다.
