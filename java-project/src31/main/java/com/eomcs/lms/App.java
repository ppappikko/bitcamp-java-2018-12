...
public class App {
  ...
  public static void main(String[] args) {
    // Application의 상태가 변경되었을 때 보고 받을 리스너(옵저버)를 등록한다.
    ...
    // Application이 시작될 때 등록된 리스너(옵저버)에게 보고한다.
    ...
    // Application이 종료될 때 다시 등록된 리스너(옵저버)를 꺼내 보고한다.
    for (ApplicationListener observer : observers) {
      try {
