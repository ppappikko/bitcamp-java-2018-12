var Bitcamp = function(arg1) { // function = object + 함수 코드
  ...
  if (arg1 instanceof HTMLElement) {
    ...
    // HTMLCollection 에 들어 있는 값을 빈 배열에 옮긴다.
    for (var e of el) {
      arr.push(e);
    }
  }
...
// xmlhttprequest
// active x controller
// 브라우저 버전에 상관없이 알아서 조건문이 다 들어 있기 때문에
// 일관된 방법으로 ajax 코드를 사용 가능

// ***크로스 브라우저 지원***
// ***코드가 가벼워짐***

// jquery는 자바스크립트의 dom api 를 더 쉽게 다룰 수 있도록
